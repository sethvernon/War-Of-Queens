...
inline bool Position::can_castle_kingside(Color side) const {
    return  castleRights & (1+int(side)); // MSM  ; NO_CASTLES
}

inline bool Position::can_castle_queenside(Color side) const {
    return castleRights & (4+4*int(side)); // MSM   NO_CASTLES
}

inline bool Position::can_castle(Color side) const {
    return can_castle_kingside(side) || can_castle_queenside(side); // MSM NO_CASTLES
}
